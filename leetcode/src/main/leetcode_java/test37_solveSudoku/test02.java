...
public class test02 {
    ...
    public static void main(String[] args) {
        char[][] nums = {{'.','.','9','7','4','8','.','.','.'},{'7','.','.','.','.','.','.','.','.'},{'.','2','.','1','.','9','.','.','.'},{'.','.','7','.','.','.','2','4','.'},{'.','6','4','.','1','.','5','9','.'},{'.','9','8','.','.','.','3','.','.'},{'.','.','.','8','.','3','.','2','.'},{'.','.','.','.','.','.','.','.','6'},{'.','.','.','2','7','5','9','.','.'}};
        solveSudoku(nums);
    }

    //三个数组分别记录9行、9列、9个子数独中9个数字的使用状态，finished记录是否完成解数独
    static boolean[][] rows=new boolean[9][9],cols=new boolean[9][9],blocks=new boolean[9][9];
    ...
    static public void dfs(char[][] board, int row, int col) {
        //0-8行都已经填写，解数独完毕
        if (row==9){
